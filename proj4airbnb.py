...
connection = pymysql.connect(host= 'localhost',user = 'root',password = 'Password1234',database = 'AIRBNB')
cursor = connection.cursor()

engine = create_engine('mysql+pymysql://root:sri123@localhost/AIRBNB', echo=False)
...
# icon = Image.open("ICN.png")
st.set_page_config(page_title= "Airbnb Data Visualization | By Sripriya",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Sripriya*!
...
client =pymongo.MongoClient("mongodb+srv://sripriya:1234@cluster0.6indntk.mongodb.net/?retryWrites=true&w=majority")
